<x-layout>
    ...
    <p class="my-6">This project began in May 2024. The goal is the create a platform that allows car enthusiasts of all types to come together and enjoy a shared passion. The platform will allow you to:
        <br />
        <ul>
    ...
    <x-forms.form action="">
        ...
        <x-forms.input label="Beta Sign Up" name="email" placeholder="email" />

        <x-forms.button type="submit">Signup</x-forms.button>

        <p class="mt-2">You will receive an email once you've been approved.</p>
    </x-forms.form>
</x-layout>
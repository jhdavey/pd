...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.forms.text-area','data' => ['label' => 'Edit note','name' => 'body','placeholder' => 'notes...','value' => ''.old('notes', $note->body).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Edit note','name' => 'body','placeholder' => 'notes...','value' => ''.old('notes', $note->body).'']); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'submit']); ?>Update Note <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
</script><?php /**PATH C:\Users\jhdav\OneDrive\coding\php\pd\resources\views/notes/edit.blade.php ENDPATH**/ ?>
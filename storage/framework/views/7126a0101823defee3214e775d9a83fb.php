        ...
        <nav x-data="{ open: false }" class="border-b border-white/10 py-4">
            <div class="flex justify-between items-center px-2">
                <div class="flex items-center space-x-6">
                    <a href="/">
                        <img class="h-[50px] mr-10" src="<?php echo e(Vite::asset('resources/images/logoFull.png')); ?>" />
                    </a>
                    <?php if(auth()->guard()->check()): ?>
                    <div class="hidden lg:flex text-lg transition-colors duration-200 space-x-6">
                        <a href="/" class="hover:text-gray-500">Browse</a>
                        <a href="<?php echo e(route('garage.show', $authUser->id)); ?>" class="hover:text-gray-500">Garage</a>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.forms.input','data' => ['label' => false,'name' => 'q','placeholder' => 'Search builds...']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(false),'name' => 'q','placeholder' => 'Search builds...']); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component->withAttributes(['action' => '/search']); ?>
                        <?php if (isset($component)) { $__componentOriginal4fb6044c7ed6b655352043ff774efcd0 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal4fb6044c7ed6b655352043ff774efcd0 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.forms.input','data' => ['class' => 'w-full sm:w-[\'100px\']','label' => false,'name' => 'q','placeholder' => 'Search Year/Make/Model']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('forms.input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-full sm:w-[\'100px\']','label' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(false),'name' => 'q','placeholder' => 'Search Year/Make/Model']); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal4fb6044c7ed6b655352043ff774efcd0)): ?>
<?php $attributes = $__attributesOriginal4fb6044c7ed6b655352043ff774efcd0; ?>
<?php unset($__attributesOriginal4fb6044c7ed6b655352043ff774efcd0); ?>
...
<?php endif; ?>
                    ...
                    <a href="<?php echo e(route('garage.show', $authUser->id)); ?>" class="block px-4 py-2 text-sm font-semibold hover:bg-white/10">Garage</a>
...
</html><?php /**PATH C:\Users\jhdav\OneDrive\coding\php\pd\resources\views/components/layout.blade.php ENDPATH**/ ?>